 ...
 *----------------------------------------------------------------------*/
/*
** $Id: feature.h,v 1.25 2005/04/19 21:39:42 cvs Exp $
*/
...
/* #define LINUX_KEYS */
/*
** Notice that we define LINUX_KEYS in the configure script based
** on the OS type we probe. Uncomment this macro unless you are
** using non-Linux system, but you want this feature. This feature
** enable the user to type Home/End key to reach the beginning/end
** of a command line in shell.
*/
