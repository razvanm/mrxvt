 ...
 *----------------------------------------------------------------------*/
/*
** $Id: command.c,v 1.214 2005/04/20 23:32:40 cvs Exp $
*/
...
int            rxvt_process_hotkeys          (rxvt_t*, int ctrl, int meta, int shft, KeySym keysym, XKeyEvent* ev);
...
/* INTPROTO */
int
rxvt_process_hotkeys (rxvt_t* r, int ctrl, int meta, int shft, KeySym keysym, XKeyEvent* ev)
{
	register int	i;
...
# endif	/* HOTKEY_CTRL */
		...
		if (ctrl || meta || shft)	/* optimization */
			if (rxvt_process_hotkeys (r, ctrl, meta, shft, keysym, ev))
				return;
